...
def create_transition_matrix(alpha, tag_counts, transition_counts):
    ...
    for i in range(num_tags):
        ...
        for j in range(num_tags):
            ...
            key = (prev_tag, curr_tag) # tuple of form (tag,tag)
...
def create_emission_matrix(alpha, tag_counts, emission_counts, vocab):
    ...
    for i in range(num_tags): # Replace None in this line with the proper range.
        ...
        for j in range(num_words): # Replace None in this line with the proper range.
            ...
            key = (tag, word) # tuple of form (tag,word)
...
def initialize(states, tag_counts, A, B, corpus, vocab):
    ...
    # index of the first observed word
    first_word_idx = vocab[corpus[0]]
    ...
    for i in range(num_tags): # Replace None in this line with the proper range.
        ...
        best_probs[i,0] = np.log(A[s_idx, i]) + np.log(B[i, first_word_idx])
